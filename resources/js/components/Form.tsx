...
export function Form () {
    ...
    return (
        <form onSubmit={handleSubmit} className="h-16 bg-white flex fixed bottom-0 w-full items-center justify-center content-between gap-3 border-t border-gray-300 p-3">

...
export function Form () {
    ...
    return (
        <form onSubmit={handleSubmit} className="h-16 bg-white flex relative w-full items-center justify-center content-between gap-3 border-t border-gray-300 p-3">
